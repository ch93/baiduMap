...
<!--    <script src="lib/jquery-2.1.4.min.js"></script>
   ...
   <title> Raw GPS trajectory </title>
	...
	<!-- 地图操作 -->
	<!-- <script type="text/javascript" src="js/ShowPoint.js"></script> -->
...
<body>
	...
	<div  class="container" style="margin-top:5px">
	  ...
	  <div class="row">
	  		<div id="allmap" class="col-md-11 " style="height:650px">
		    </div>

			<div id="r-result" class="col-md-1 ">
			
			    <div class="btn-group-vertical"  style="margin-top: 10px">
					  <button type="button" class="btn btn-default" onclick="add_overlay();">添加覆盖物</button>
					  <button type="button" class="btn btn-default" onclick="add_lable();">添加点标注</button>
					  <button type="button" class="btn btn-default" onclick="addPolyline();"> 绘    线</button>
					  <button type="button" class="btn btn-default" onclick="remove_overlay();">删除覆盖物</button>
				
				</div>
				
				 	<button type="button" class="btn btn-default" style="margin-top: 20px" onclick="DistanceMeasure();">鼠标测距</button>
